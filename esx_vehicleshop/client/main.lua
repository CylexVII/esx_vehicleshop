local Keys = {
  ...
  Citizen.CreateThread(function ()
	...
	Citizen.Wait(1)
	  ...
	  scaleform = Initialize("mp_car_stats_01", veh, GetDisplayNameFromVehicleModel(model))
					  ...
					  if Config.LicenseEnable then
						  ...
						  ESX.TriggerServerCallback('esx_license:checkLicense', function(hasDriversLicense)
							  if hasDriversLicense then
								  ...
								  exports['rootNotify']:showNotification('error', 'Araç satın alabilmek için ilk önce ehliyet alman gerekiyor!', 'Uyarı', 2500)
